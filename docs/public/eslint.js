    module.exports = {
        ...
        // 解析器选项
        parserOptions: {
        ecmaVersion: 2018,  // 使用的 ECMAScript 版本
        sourceType: 'module' // 设置为 "module" 以允许使用 import/export
        },
        ...
        'jsdoc/require-description': ['error'],                     // 要求 JSDoc 包含描述
        'jsdoc/require-param': ['error'],                           // 要求记录所有函数参数
        'jsdoc/require-param-description': ['error'],               // 要求参数描述
        'jsdoc/require-param-type': ['error'],                      // 要求参数类型
        'jsdoc/require-returns': ['error', {
            'forceReturnsWithAsync': true
        }],                                                         // 要求记录返回值
        'jsdoc/require-returns-description': ['error'],             // 要求返回值描述
